...
<body>
  <div class="site-wrapper">
      ...
      <div class="mira-container">
        ...
        <div class="mira-grid">
          <div class="mira-card">
            ...
            <p>Пока не состоит в сельдерейхе!</p>
            <p>Любит своих подписчиков ❤️</p>
          </div>
          <div class="mira-card">
    ...
    <section class="green-section">
      <div class="green-container">
        ...
        <div class="ticket-box">
          ...
          <p style="font-size:1.5rem; margin-top:1rem;">👥 косплей-скидка действует ... ???</p>
        </div>
    ...
    <footer>
      ...
      <p style="font-size:0.9rem;">*Настям приходить обязательно!!!</p>
    </footer>
  </div>
</body>
</html>
